codeunit 84048 DYM_HeartBeatManagement
{
    SingleInstance = true;
    ...
    begin
        ...
        if HeartBeatBuffer.FindSet then repeat HeartBeatBuffer.SetRange("Job Queue Entry Id", HeartBeatBuffer."Job Queue Entry Id");
    ...
    begin
        ...
        if(HeartBeat.FindSet())then repeat Clear(ResultHeartBeatBuffer);
                ResultHeartBeatBuffer.Init();
