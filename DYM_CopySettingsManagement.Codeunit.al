codeunit 84046 DYM_CopySettingsManagement
{
    var UpdateCount, InsertCount: Integer;
    ...
    begin
        ...
        if(Process)then begin
            ...
            if(SourceSettingAssignment.FindSet())then repeat TargetSettingAssignment.Reset();
    ...
    local procedure AskQuestionForCopy(SourceHierrarchyType: Enum DYM_HierarchyType; SourceHierrarchyMember: Text; TargetHierrarchyType: Enum DYM_HierarchyType; TargetHierrarchyMember: Text): Boolean begin
    ...
    begin
        case HierrarchyType of Enum::DYM_HierarchyType::" ": Error(Text0003);
        Enum::DYM_HierarchyType::Role: DeviceRole.Get(HierarchyMember);
    ...
    begin
        case HierrarchyType of Enum::DYM_HierarchyType::" ": Error(Text0002);
        Enum::DYM_HierarchyType::Role: begin
