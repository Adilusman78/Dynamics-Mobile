codeunit 84005 DYM_JobQueueDispatcher
{
    ...
    var Text001: Label 'You must assign a parameter to the job queue. Valid values for parameter are: ALL, FETCH, LOAD, PARSE, PROCESS, POSTPROCESS, UPLOAD';
