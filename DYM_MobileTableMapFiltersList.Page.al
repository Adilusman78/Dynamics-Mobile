page 84015 DYM_MobileTableMapFiltersList
{
    ...
    begin
        case Rec."Filter Type" of Rec."Filter Type"::"Session Value": Text:=SessionMgt.GetSessionValueDescription(Rec."Filter Value");
        Rec."Filter Type"::Field: if Evaluate(FieldFilterFieldNo, Rec."Filter Value")then Text:=LowLevelDP.GetFieldName(Rec.GetParentTableNo, FieldFilterFieldNo);
        end;
    end;
