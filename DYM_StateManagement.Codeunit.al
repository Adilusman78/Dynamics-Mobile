codeunit 84039 DYM_StateManagement
{
    var StateVar: Record DYM_StateVariable;
    procedure GetStateVar(StateVarContext: Code[100]; StateVarCode: Code[100])Result: Text[100]begin
        clear(Result);
