page 84058 DYM_ReverseNavigate
{
    ...
    begin
        ...
        if(DocumentNo <> '')then begin
            ...
            if RawDataLog.FindSet()then repeat UpdateBuffers(RawDataLog."Sync Log Entry No.");
            ...
            if DataLog.FindSet(false, false)then repeat DataLogBuffer.Init;
    ...
    begin
        ...
        if((DeviceSetupRecCount <> 0) or (SyncLogRecCount <> 0) or (DataLogRecCount <> 0))then Message(Text002, DocumentNo, DeviceSetupRecCount, SyncLogRecCount, DataLogRecCount)
        else
