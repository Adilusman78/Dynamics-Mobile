codeunit 84201 DYM_SL_Helper
{
    ...
    begin
        ...
        case UseMobileNo of false: begin
        ...
        case(LowLevelDP.IsNumStr(_applyToDocNo))of true: begin
            if CustLedgerEntry.Get(LowLevelDP.Text2Integer(_applyToDocNo))then GenJnlLine."Applies-to Doc. No.":=CustLedgerEntry."Document No."
            else
                GenJnlLine."Applies-to Doc. No.":=_applyToDocNo;
        end;
        false: GenJnlLine."Applies-to Doc. No.":=_applyToDocNo;
        end;
    ...
    procedure GetSalesItemLedgerEntry(_SalesInvoiceNo: Code[20]; _ItemNo: Code[20]; _VariantCode: Code[10]; _SerialNo: Code[50]; _LotNo: Code[50])Result: Integer var
    ...
    begin
        ...
        if ValueEntry.FindSet()then repeat ItemLedgerEntry.Get(ValueEntry."Item Ledger Entry No.");
