page 84103 DYM_DAO_BS_WarehouseEntrySum
{
    PageType = API;
    ...
    local procedure CalcQtyAvail(_WhseEntry: Record "Warehouse Entry")Result: Decimal begin
        clear(Result);
        BinContent.Reset();
    ...
    begin
        ...
        if WarehouseEntry.FindSet(false, false)then repeat Rec.Reset;
