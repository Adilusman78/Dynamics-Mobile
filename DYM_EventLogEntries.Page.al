page 84011 DYM_EventLogEntries
{
    ...
    procedure GetColor()Result: Integer begin
        Clear(Result);
        case Rec."Event Type" of Rec."Event Type"::Info, Rec."Event Type"::Warning: exit(0);
        Rec."Event Type"::Error: exit(ConstMgt.CLR_ProblemSeverity1);
        Rec."Event Type"::Debug: exit(ConstMgt.CLR_Debug);
        end;
    end;
    procedure ShowData()
    var
