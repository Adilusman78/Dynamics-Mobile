codeunit 84031 DYM_DataLogManagement
{
    ...
    begin
        case EntryType of enum::DYM_DataLogEntryType::Incoming: CacheMgt.SetStateDescription(StrSubstNo(ConstMgt.MSG_0009, RecRef.Name, LowLevelDP.RecordRefPK2TextDescriptive(RecRef)));
        enum::DYM_DataLogEntryType::Create: CacheMgt.SetStateDescription(StrSubstNo(ConstMgt.MSG_0010, RecRef.Name, LowLevelDP.RecordRefPK2TextDescriptive(RecRef)));
        enum::DYM_DataLogEntryType::Modify: CacheMgt.SetStateDescription(StrSubstNo(ConstMgt.MSG_0011, RecRef.Name, LowLevelDP.RecordRefPK2TextDescriptive(RecRef)));
        end;
    ...
    procedure GetPositionWithNames(DataLog: Record DYM_DataLog): Text[250]begin
