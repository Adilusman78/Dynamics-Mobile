page 70171 DYM_SettingsAssignmentOverview
{
    ...
    begin
        ...
        if (BusinessSettings.FindSet()) then
            repeat
    ...
    local procedure GetSettingValue(ColumnId: Integer): Text
    var
        BusinessSettingsAssignment: Record DYM_SettingsAssignment;
    ...
    var
        BusinessSettings: Record DYM_Settings;
