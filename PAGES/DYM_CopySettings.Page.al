page 70102 DYM_CopySettings
{
    ...
    var
        CopySettingsMgt: Codeunit DYM_CopySettingsManagement;
    ...
    begin
        ...
        case sourceHierrarchyType of
            ...
            Enum::DYM_HierarchyType::Device:
                sourceSettingAssignment.SetRange("Device Setup Code", sourceHierrarchyMember);
        end;
