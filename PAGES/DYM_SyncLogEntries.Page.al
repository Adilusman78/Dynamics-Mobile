page 70176 DYM_SyncLogEntries
{
    ...
    var
        Text001: Label 'You have been selected multiple synclog entries to be set to Debug status. If you set the status to Debug the Sync Log Entries can not be handled. Do you want to continue?';
