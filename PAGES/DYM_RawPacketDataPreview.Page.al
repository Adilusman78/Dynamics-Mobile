page 70155 DYM_RawPacketDataPreview
{
    ...
    begin
        ...
        if Data.FindSet(false, false) then
            repeat
                CellPos += 1;
    ...
    begin
        ...
        Data.DeleteAll;
        l_Data.Reset;
        if l_Data.FindSet(false, false) then
            repeat
                Data.Init;
                Data.Copy(l_Data);
                Data.Insert;
    ...
    begin
        ...
        if Data.FindSet(false, false) then
            repeat
                if ((Data."Record ID" <> xRecID) and (xRecID <> '')) then Clear(CellPos);
                CellPos += 1;
    ...
    begin
        case CellNo of
            1:
                CellEditable01 := CellEditable[1];
            2:
                CellEditable02 := CellEditable[2];
            3:
                CellEditable03 := CellEditable[3];
            4:
                CellEditable04 := CellEditable[4];
            5:
                CellEditable05 := CellEditable[5];
            6:
                CellEditable06 := CellEditable[6];
            7:
                CellEditable07 := CellEditable[7];
            8:
                CellEditable08 := CellEditable[8];
            9:
                CellEditable09 := CellEditable[9];
            10:
                CellEditable10 := CellEditable[10];
            11:
                CellEditable11 := CellEditable[11];
            12:
                CellEditable12 := CellEditable[12];
            13:
                CellEditable13 := CellEditable[13];
            14:
                CellEditable14 := CellEditable[14];
            15:
                CellEditable15 := CellEditable[15];
            16:
                CellEditable16 := CellEditable[16];
            17:
                CellEditable17 := CellEditable[17];
            18:
                CellEditable18 := CellEditable[18];
            19:
                CellEditable19 := CellEditable[19];
            20:
                CellEditable20 := CellEditable[20];
            21:
                CellEditable21 := CellEditable[21];
            22:
                CellEditable22 := CellEditable[22];
            23:
                CellEditable23 := CellEditable[23];
            24:
                CellEditable24 := CellEditable[24];
            25:
                CellEditable25 := CellEditable[25];
            26:
                CellEditable26 := CellEditable[26];
            27:
                CellEditable27 := CellEditable[27];
            28:
                CellEditable28 := CellEditable[28];
            29:
                CellEditable29 := CellEditable[29];
            30:
                CellEditable30 := CellEditable[30];
            31:
                CellEditable31 := CellEditable[31];
            32:
                CellEditable32 := CellEditable[32];
        end;
    end;
}
