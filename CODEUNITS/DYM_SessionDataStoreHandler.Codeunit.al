codeunit 70143 DYM_SessionDataStoreHandler
{
    var
    ...
    procedure WAL_Split_Pop(WarehouseActivityLine: Record "Warehouse Activity Line"): Integer
    begin
        exit(SDSMgt.PopInteger(WAL_Split_GetKey(WarehouseActivityLine)));
    end;

    procedure WAL_Split_GetKey(WarehouseActivityLine: Record "Warehouse Activity Line"): Text
    begin
    ...
    procedure PP_Flag_Skipped_Pop(PostProcessEntry: Record DYM_PostProcessLog): Boolean
    begin
        Exit(SDSMgt.PopValue(PP_Flag_Skipped_GetKey(PostProcessEntry)) = V_PPR_StatusFlag_Skipped);
    end;

    procedure PP_Flag_Skipped_GetKey(PostProcessEntry: Record DYM_PostProcessLog): Text
    begin
    ...
    procedure PP_EDL_SalesShipmentHeader_Get(): Text
    begin
    ...
    procedure PP_EDL_TransferShipmentHeader_Get(): Text
    begin
    ...
    procedure PP_EDL_TransferReceiveHeader_Get(): Text
    begin
    ...
    procedure PP_EDL_PurchReceiveHeader_Get(): Text
    begin
    ...
    procedure PP_EDL_PurchInvoiceHeader_Get(): Text
    begin
    ...
    procedure PP_EDL_PurchCRMemoHeader_Get(): Text
    begin
