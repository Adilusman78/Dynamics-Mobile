codeunit 70111 DYM_DashboardManagement
{
    trigger OnRun()
    begin
    end;
    ...
    procedure GetPacketsCount(_DeviceSetupCode: Code[100]; Direction: enum DYM_PacketDirection; Status: enum DYM_PacketStatus) Result: Integer
    var
    ...
    procedure GetSettingsSynced() Result: Boolean
    begin
        Clear(Result);
        CacheMgt.GetSetup_NoContext(MobileSetup, SetupRead);
    ...
    procedure GetActiveGroups() Result: Integer
    var
    ...
    procedure GetActiveDevices() Result: Integer
    var
        DeviceGroup: Record DYM_DeviceGroup;
    ...
    begin
        ...
        DeviceGroup.Reset;
        DeviceGroup.SetRange(Disabled, false);
        if DeviceGroup.FindSet(false, false) then
            repeat
                DeviceSetup.Reset;
