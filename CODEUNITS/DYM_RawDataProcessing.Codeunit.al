codeunit 70139 DYM_RawDataProcessing
{
    TableNo = DYM_SyncLog;
    ...
    begin
        ...
        for i := 1 to (AttributeNodeList.Count()) do begin
            ...
            case EntryType of
                enum::DYM_RawDataLogEntryType::"Global Attribute":
                    begin
                ...
                enum::DYM_RawDataLogEntryType::"Table Attribute":
                    InsertTableAttributeRawDataLogEntry(TableName, AttributeName, AttributeValue);
                enum::DYM_RawDataLogEntryType::"Record Attribute":
                    InsertRecordAttributeRawDataLogEntry(TableName, RecordNo, AttributeName, AttributeValue);
                enum::DYM_RawDataLogEntryType::"Field Attribute":
                    InsertFieldAttributeRawDataLogEntry(TableName, RecordNo, FieldName, AttributeName, AttributeValue);
            end;
        end;
    end;
    #endregion 
    ...
    procedure CheckRawDataLogEntry(EntryType: enum DYM_RawDataLogEntryType; TableName: Text; RecordNo: Integer; FieldName: Text; AttributeName: Text) Result: Boolean
    var
        RawDataLog: Record DYM_RawDataLog;
    begin
        Clear(Result);
    ...
    procedure CheckTableFieldRawDataLogEntry(TableName: Text; FieldName: Text): Boolean
    begin
        exit(CheckRawDataLogEntry(enum::DYM_RawDataLogEntryType::TableField, TableName, 0, FieldName, ''));
    end;

    procedure RawDataEntryValueMaxLength(): Integer
    var
        RawDataLog: Record DYM_RawDataLog;
    begin
    ...
    procedure Mobile2BackendTableName(_TableName: Text) Result: Text
    var
        MobileTableMap: record DYM_MobileTableMap;
    begin
        Result := _TableName;
    ...
    begin
        ...
        if MobileTableMap.FindFirst() then begin
            ...
            if MobileFieldMap.FindSet() then
                repeat
                    Result := LowLevelDP.ValidateText(LowLevelDP.GetFieldName(MobileFieldMap."Table No.", MobileFieldMap."Field No."));
