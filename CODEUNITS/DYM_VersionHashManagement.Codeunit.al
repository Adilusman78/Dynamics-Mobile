codeunit 70160 DYM_VersionHashManagement
{
    var
        IntegrityModuleVersionTemplate: Label '[%1][%2]', Locked = true;

    procedure calcIntegrityModulesVersionHash(): Integer
    var
    ...
    begin
        ...
        if IntegrityModInfo.FindSet() then
            repeat
                if not InstalledApps.Get(IntegrityModInfo."App Id") then clear(InstalledApps);
