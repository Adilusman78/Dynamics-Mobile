codeunit 70156 DYM_SyncManagement
{
    trigger OnRun()
    begin
    end;
    ...
    begin
        ...
        l_DeviceRole.Reset;
        if l_DeviceRole.FindSet(false, false) then
            repeat
                XMLMgt.AddElementNS(Node, ConstMgt.DES_NamespacePrefix(), ConstMgt.DES_NamespaceURI(), ConstMgt.DES_Role, '', Node2);
        ...
        l_DeviceGroup.Reset;
        if l_DeviceGroup.FindSet(false, false) then
            repeat
                XMLMgt.AddElementNS(Node, ConstMgt.DES_NamespacePrefix(), ConstMgt.DES_NamespaceURI(), ConstMgt.DES_Group, '', Node2);
        ...
        l_DeviceSetup.Reset;
        if l_DeviceSetup.FindSet(false, false) then
            repeat
                XMLMgt.AddElementNS(Node, ConstMgt.DES_NamespacePrefix(), ConstMgt.DES_NamespaceURI(), ConstMgt.DES_Device, '', Node2);
        ...
        if l_SettingsAssignment.FindSet(false, false) then
            repeat
                XMLMgt.AddElementNS(Node, ConstMgt.DES_NamespacePrefix(), ConstMgt.DES_NamespaceURI(), ConstMgt.DES_Setting, '', Node2);
    ...
    procedure GenerateDESFileName() Result: Text[250]
    var
        GUID: Text[250];
        Extension: Text[250];
    begin
    ...
    begin
        ...
        if l_DeviceRole.FindSet(false, false) then
            repeat
                XMLMgt.AddElementNS(RootNode, ConstMgt.DBS_NamespacePrefix(), ConstMgt.DBS_NamespaceURI(), ConstMgt.DBS_Role, '', RoleNode);
                ...
                if TableMap.FindSet(false, false) then
                    repeat
                        NAVTableName := LowLevelDP.GetTableName(TableMap."Table No.");
                        ...
                        if FieldMap.FindSet(false, false) then
                            repeat
                                FieldMap.CalcFields("NAV Field Name", "NAV Field Type", "NAV Field Size");
    ...
    procedure GenerateDBSFileName() Result: Text[250]
    var
        GUID: Text[250];
        Extension: Text[250];
    begin
