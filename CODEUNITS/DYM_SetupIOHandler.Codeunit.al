codeunit 70147 DYM_SetupIOHandler
{
    var
    ...
    begin
        ...
        case ToFile of
            true:
                SetupIOMgt.WriteOutputFile;
            false:
                SetupIOMgt.ExportBlob(StreamWriter, JObj, Enum::DYM_BackupRestoreType::Full);
        end;
    ...
    begin
        ...
        case ToFile of
            true:
                SetupIOMgt.WriteOutputFile;
            false:
                SetupIOMgt.ExportBlob(StreamWriter, JObj, Enum::DYM_BackupRestoreType::Settings);
        end;
        SetupIOMgt.CloseStreamWriter;
    end;
    ...
    begin
        ...
        case ToFile of
            true:
                SetupIOMgt.WriteOutputFile;
            false:
                SetupIOMgt.ExportBlob(StreamWriter, JObj, Enum::DYM_BackupRestoreType::"Device Hierarchy");
        end;
        SetupIOMgt.CloseStreamWriter;
    end;
    ...
    begin
        ...
        case ToFile of
            true:
                SetupIOMgt.WriteOutputFile;
            false:
                SetupIOMgt.ExportBlob(StreamWriter, JObj, Enum::DYM_BackupRestoreType::Mapping);
        end;
        SetupIOMgt.CloseStreamWriter;
    end;
    ...
    begin
        ...
        case ToFile of
            true:
                SetupIOMgt.WriteOutputFile;
            false:
                SetupIOMgt.ExportBlob(StreamWriter, JObj, Enum::DYM_BackupRestoreType::"Log tables");
        end;
        SetupIOMgt.CloseStreamWriter;
    end;
