codeunit 70148 DYM_SetupIOManagement
{
    var
    ...
    procedure SelectInputFile() Result: Text
    begin
        clear(FileMgt);
    ...
    procedure SetExportFormat(_ExportFormat: Enum DYM_BackupRestoreFormat): Boolean
    begin
    ...
    procedure GetFileSize() Result: Integer
    begin
    ...
    procedure GenSettingsStorageDescription(BackupRestoreType: Enum DYM_BackupRestoreType) Result: Text
    begin
