codeunit 70136 DYM_PacketStorageManagement
{
    TableNo = DYM_SyncLog;
    ...
    procedure getPacketLength(var _syncLog: Record DYM_SyncLog): Integer
    begin
        _syncLog.CalcFields(Packet);
        exit(_syncLog.Packet.Length());
    end;

    procedure getPacketChecksum(var _syncLog: Record DYM_SyncLog): Text
    var
        inS: InStream;
