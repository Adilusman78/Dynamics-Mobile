codeunit 70135 DYM_PacketScheduler
{
            ...
            GroupLevel:
                begin
                    ...
                    if (GeneratePerDevice) then begin
                        ...
                        CacheMgt.SetContext(DeviceRole, DeviceGroup, DeviceSetup, 0);
                        GlobalDP.InsertSyncLogEntry('', enum::DYM_PacketDirection::Push, enum::DYM_PacketType::Data, enum::DYM_PullType::Group, true, false, InS)
                    end;
                end;
            DeviceLevel:
                begin
                    ...
                    if not (DeviceSetup.Disabled) then begin
                        CacheMgt.SetContext(DeviceRole, DeviceGroup, DeviceSetup, 0);
                        GlobalDP.InsertSyncLogEntry('', enum::DYM_PacketDirection::Push, enum::DYM_PacketType::Data, enum::DYM_PullType::Device, true, false, InS)
                    end
                    else begin
                        Error(Text003);
                    end;
