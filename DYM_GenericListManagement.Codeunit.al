codeunit 84032 DYM_GenericListManagement
{
    trigger OnRun()
    begin
    end;
    var List: Record DYM_CacheBuffer temporary;
    ...
    begin
        ...
        if(SelectedKey <> 0)then Key:=SelectedKey
