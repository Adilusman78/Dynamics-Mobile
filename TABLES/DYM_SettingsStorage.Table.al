table 70126 DYM_SettingsStorage
{
    fields
    {
    ...
    begin
        ...
        case Rec.Format of
            Rec.Format::CSV:
                tempFilename := CreateGuid() + CSVFormatFileExtension;
            Rec.Format::JSON:
                tempFilename := CreateGuid() + JSONFormatFileExtension;
        end;
    ...
    begin
        case Rec.Type of
            BackupRestoreType::Full:
                SetupIOHandler.TruncateFull();
            BackupRestoreType::Mapping:
                SetupIOHandler.TruncateMapping();
            BackupRestoreType::"Device Hierarchy":
                SetupIOHandler.TruncateDeviceHierarchy();
            BackupRestoreType::Settings:
                SetupIOHandler.TruncateSettings();
            BackupRestoreType::"Log tables":
                SetupIOHandler.TruncateLogTables();
        end;
    ...
    begin
        ...
        case Rec.Type of
            BackupRestoreType::Full:
                SetupIOHandler.ImportFull(false);
            BackupRestoreType::Mapping:
                SetupIOHandler.ImportMapping(false);
            BackupRestoreType::"Device Hierarchy":
                SetupIOHandler.ImportDeviceHierarchy(false);
            BackupRestoreType::Settings:
                SetupIOHandler.ImportSettings(false);
            BackupRestoreType::"Log tables":
                SetupIOHandler.ImportLogTables(false);
        end;
