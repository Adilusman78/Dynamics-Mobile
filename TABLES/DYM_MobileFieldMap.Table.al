table 70114 DYM_MobileFieldMap
{
    ...
    fields
    {
        ...
        field(16; Direction; enum DYM_MobileFieldMapDirection)
        {
            ...
            trigger OnValidate()
            begin
                if (Direction <> Direction::Internal) then
                    if ("Session Value" <> '') then
                        if Confirm(ConstMgt.MSG_0001, false, FieldCaption(Direction), FieldCaption("Session Value")) then
                            Clear("Session Value")
                        else
                            Error('');
    ...
    procedure GetParentTableNo() Result: Integer
    var
        TableMap: Record DYM_MobileTableMap;
    begin
        Clear(Result);
    ...
    procedure GetParentTableIndex() Result: Integer
    var
        TableMap: Record DYM_MobileTableMap;
    begin
        Clear(Result);
    ...
    procedure GetNextFieldIndex() Result: Integer
    var
    ...
    procedure GetMobileTableName() Result: Text[30]
    var
        TableMap: Record DYM_MobileTableMap;
    begin
        Clear(Result);
