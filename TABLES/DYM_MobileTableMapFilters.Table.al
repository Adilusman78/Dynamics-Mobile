table 70116 DYM_MobileTableMapFilters
{
    ...
    begin
        case "Filter Type" of
            "Filter Type"::Filter:
                SessionMgt.ShowSessionValuesHint;
            "Filter Type"::"Session Value":
                begin
    ...
    begin
        ...
        else if ("FlowFilter to Field No." <> 0) then
            if Confirm(ConstMgt.MSG_0005, false, FieldCaption("FlowFilter to Field No.")) then begin
