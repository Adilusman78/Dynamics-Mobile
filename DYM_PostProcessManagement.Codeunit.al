codeunit 84025 DYM_PostProcessManagement
{
    ...
    procedure LogPostProcessOperation(var RecRef: RecordRef; OpType: enum DYM_PostProcessOperationType; Parameters: Text[250]; Dependancy: BigInteger; Subsequent: Boolean; Data: Text[250]): BigInteger begin
    ...
    procedure InsertPostProcessEntry(TableNo: Integer; Position: Text[250]; OpType: enum DYM_PostProcessOperationType; Parameters: Text[250]; Dependancy: BigInteger; Subsequent: Boolean; Data: Text[250]): BigInteger var
    ...
    begin
        ...
        if not IsHandled then begin
            case PostProcessEntry."Table No." of DATABASE::"Warehouse Activity Header": PostProcessHandler.PostProcessWhseActivityHeader();
            DATABASE::"Transfer Header": PostProcessHandler.PostProcessTransferHeader();
            DATABASE::"Warehouse Shipment Header": PostProcessHandler.PostProcessWhseShptHeader();
            DATABASE::"Warehouse Receipt Header": PostProcessHandler.PostProcessWhseRcptHeader();
            DATABASE::"Posted Whse. Shipment Header": PostProcessHandler.PostProcessPostedWhseShptHdr();
            DATABASE::"Posted Whse. Receipt Header": PostProcessHandler.PostProcessPostedWhseRcptHdr();
            DATABASE::"Sales Shipment Header": PostProcessHandler.PostProcessSalesShptHeader();
            DATABASE::"Purch. Rcpt. Header": PostProcessHandler.PostProcessPurchRcptHeader();
            DATABASE::"Transfer Shipment Header": PostProcessHandler.PostProcessTransShptHeader();
            DATABASE::"Transfer Receipt Header": PostProcessHandler.PostProcessTransRcptHeader();
            Database::"Sales Header": PostProcessHandler.PostProcessSalesHeader();
            Database::"Purchase Header": PostProcessHandler.PostProcessPurchaseHeader();
            Database::"Item Journal Line": PostProcessHandler.PostProcessItemJnl();
            else
            begin
    ...
    procedure GetParentPostProcessEntry(PostProcessEntry: Record DYM_PostProcessLog): BigInteger var
        ParentPostProcessEntry: Record DYM_PostProcessLog;
    begin
        if ParentPostProcessEntry.Get(PostProcessEntry.Dependancy)then begin
            if(ParentPostProcessEntry.Dependancy = 0)then exit(ParentPostProcessEntry."Entry No.")
            else
                exit(GetParentPostProcessEntry(ParentPostProcessEntry));
        end;
    end;
    procedure GetPositionWithNames(PostProcessLog: Record DYM_PostProcessLog): Text[250]begin
