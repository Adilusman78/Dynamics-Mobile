page 84007 DYM_DAO_CR_EffectiveSettings
{
    PageType = API;
    ...
    begin
        ...
        DeviceSetup.Reset;
        If DeviceSetup.FindSet(False, False)then repeat //Global settings are not used in device hierarchy context
    ...
    begin
        if _FromSettingsAss.FindSet(False, False)then repeat _ToSettingsAss.Reset;
