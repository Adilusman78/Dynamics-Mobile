page 84019 DYM_DashboardSubpage
{
        ...
        area(content)
        {
            repeater(Control1103109000)
            {
                ...
                field(tbox_Pending; Values[1])
                {
                    ...
                    trigger OnDrillDown()
                    begin
                        DashboardMgt.DrillDownPackets(Rec.Code, enum::DYM_PacketDirection::Push, enum::DYM_PacketStatus::Pending)end;
                }
                field(tbox_Success; Values[2])
                {
                    ...
                    trigger OnDrillDown()
                    begin
                        DashboardMgt.DrillDownPackets(Rec.Code, enum::DYM_PacketDirection::Push, enum::DYM_PacketStatus::Success)end;
                }
                field(tbox_Failed; Values[3])
                {
                    ...
                    trigger OnDrillDown()
                    begin
                        DashboardMgt.DrillDownPackets(Rec.Code, enum::DYM_PacketDirection::Push, enum::DYM_PacketStatus::Failed)end;
                }
                field(tbox_Error; Values[4])
                {
                    ...
                    trigger OnDrillDown()
                    begin
                        DashboardMgt.DrillDownPackets(Rec.Code, enum::DYM_PacketDirection::Push, enum::DYM_PacketStatus::Error)end;
                }
            }
        }
    }
    ...
    procedure GetColor(): Integer begin
