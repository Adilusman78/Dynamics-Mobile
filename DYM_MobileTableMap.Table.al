table 84001 DYM_MobileTableMap
{
    ...
    procedure CheckFieldMapExists()Result: Boolean var
        FieldMap: Record DYM_MobileFieldMap;
    begin
        FieldMap.Reset;
        FieldMap.SetRange("Device Role Code", "Device Role Code");
    ...
    procedure GetNextTableIndex()Result: Integer var
        TableMap: Record DYM_MobileTableMap;
    begin
        Clear(Result);
        TableMap.Reset;
    ...
    procedure LookUpTableKeys(var KeyValue: Integer)Result: Integer var
