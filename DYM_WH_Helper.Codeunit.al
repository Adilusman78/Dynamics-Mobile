codeunit 84304 DYM_WH_Helper
{
    ...
    begin
        ...
        begin
            ...
            if(_ZoneCode <> '')then WhseJnlLine.Validate("Zone Code", _ZoneCode)
            ...
            if(_ItemJnlHandlingType = _ItemJnlHandlingType::StockCorrection)then begin
                ...
                case WhseJnlLine."Entry Type" of WhseJnlLine."Entry Type"::"Negative Adjmt.": begin
                    WhseJnlLine.Validate("Qty. (Calculated)", _Quantity);
                    WhseJnlLine.Validate("Qty. (Phys. Inventory)", 0);
                end;
                WhseJnlLine."Entry Type"::"Positive Adjmt.": begin
    ...
    begin
        ...
        IF((NOT ItemJnlLine.FINDFIRST) OR (_ItemJnlHandlingType <> _ItemJnlHandlingType::PhysInventory))Then Begin
            ...
            case _ItemJnlHandlingType of _ItemJnlHandlingType::PhysInventory: begin
        ...
        //Reread record
        ItemJnlLine.Find();
        case _ItemJnlHandlingType of _ItemJnlHandlingType::None: error(ErrMsg_InvalidItemJournalHandlingType);
        _ItemJnlHandlingType::PhysInventory: begin
            ItemJnlLine.VALIDATE("Qty. (Phys. Inventory)", ItemJnlLine."Qty. (Phys. Inventory)" + _QtyCounted);
        end;
        _ItemJnlHandlingType::Output: begin
 ...
 ''); //_OperationNo);
    ...
    begin
        ...
        if LineRecRef.FindSet()then repeat Clear(AccFieldValue);
        ...
        case FullyProcessed of true: FldRef.Value:=Enum::DYM_BS_MobileStatus::Processed;
        false: FldRef.Value:=Enum::DYM_BS_MobileStatus::"Partially Processed";
        end;
    ...
    local procedure GetLineTableNo(_HeaderTableNo: Integer)Result: Integer var
        HeaderLineDict: Dictionary of[Integer, Integer];
    begin
        Clear(Result);
    ...
    local procedure ApplyHeader2LinesFilter(_HeaderRec: Variant; var _LineRecRef: RecordRef)Result: Text var
